...
export function ProcessInMotion() {
  ...
  return (
    <section ref={sectionRef} className="relative h-[300vh]">
      <div className="sticky top-0 h-screen overflow-hidden bg-[#0b1220]">
        {/* Garage backdrop: dark gradient + red glow, matching the service-page hero graphics. */}
        <div
          aria-hidden="true"
          className="absolute inset-0 -z-30"
          style={{
            backgroundImage: "linear-gradient(135deg, #0b1220 0%, #101a2e 55%, #1a1210 100%)",
          }}
        />
        <div
          aria-hidden="true"
          ...
          style={{
            backgroundImage:
              "radial-gradient(60% 60% at 78% 60%, rgb(224 67 47 / 0.28), transparent 70%)",
          }}
        />
        <div
          aria-hidden="true"
